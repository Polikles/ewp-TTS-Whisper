...
implemented; the next slice is application-level preview and atomic apply. Revision
configuration, filename allocation, atomic storage, strict `EWP-REVIEW 1`
parsing/rendering, and safe model-free single/batch `revise prepare` are implemented.
