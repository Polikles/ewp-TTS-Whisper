...
class WarningCode(StrEnum):
    ...
    INPUT_FILENAME_WHITESPACE = "INPUT_FILENAME_WHITESPACE"
    ...
    SPEAKER_ASSIGNMENT_MISSING = "SPEAKER_ASSIGNMENT_MISSING"
    SPEAKER_ASSIGNMENT_AMBIGUOUS = "SPEAKER_ASSIGNMENT_AMBIGUOUS"
