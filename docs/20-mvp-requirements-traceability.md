...
| FR-K02, FR-K04 | implemented | Strict versioned response/change validation and the hashed LM Studio faithful-repair prompt prohibit paraphrase, style/grammar repair, summary, translation, and meaningful deletion. |
