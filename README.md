...
- MVP implementation: functional and operational gates complete for the validated Polish workflows; version `0.1.0` is an internal release candidate, not a public release.
