# ewp-TTS-Whisper
Local tool for making transcripts from recordings of EWP podcast

The tool is based on Whisper TTS model. The plan is to create a workflow for making time-stamped transcripts
